...
export default function Sidebar({ user }) {
  ...
  const navigation = [
    ...
    { name: 'Saved Resume', path: '/resume', icon: 'M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z' },
    { name: 'Survey Request', path: '/survey', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  ]
    ...
    <div className="w-64 bg-white border-r border-gray-100 min-h-screen flex flex-col shadow-sm">
      ...
      <div className="px-8 py-5 border-b border-gray-100 flex items-center">
        <div className="flex items-center space-x-2">
          <div className="text-2xl font-bold text-gray-900">JobTrack</div>
      ...
      <div className="p-4 border-t border-gray-100">
        <button
          ...
          className="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition w-full text-red-600 hover:bg-red-50"
        >
          <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
